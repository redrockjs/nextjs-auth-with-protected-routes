...
export default function MenuItems(
  ...
  useEffect(() => {
    if (menuItemsRef.current
      && document.body.offsetWidth - (menuItemsRef.current.offsetParent as HTMLDivElement).offsetLeft < menuItemsRef.current.offsetWidth) {
      setOffset('right');
    } else if (menuItemsRef.current
      && document.body.offsetWidth - (menuItemsRef.current.offsetParent as HTMLDivElement).offsetLeft > menuItemsRef.current.offsetWidth) {
      setOffset('left');
    }
  }, []);
  ...
  const moveToNext = (targetItem: any) => {
